...
see the S1 evidence manifests. N1 web research does not grant adapter or
...
| BLS / Federal Reserve schedules and releases | N1 | Exact calendar, release/feed and applicable terms; source links in N1 feature | Pending scope/terms review | Unknown | Research only |
| Congress.gov legislation | N1 | Bill/text/action APIs and reuse terms; H.R. 3633 linked in CRCL example | Pending scope/terms review | Unknown | Research only |
| Circle IR / product disclosures and metrics | N1 | Exact pages/feed, archive scope and issuer terms; CRCL example | Pending terms review; distinct from SEC-hosted filings | Unknown | Research only |
| Open Standard announcements / partner directory | N1 | https://joinopenstandard.com/ and announcement/directory links in CRCL example; verify polling, retention and reuse | Pending terms review | Unknown | Research only |
| Reap Open USD explainer | N1 discovery reference | User-supplied article linked in CRCL example; participant-authored context | No recurring adapter selected; reuse terms pending | Unknown | Research only |
