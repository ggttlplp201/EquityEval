...
| S4 — Prices and FRED | S3 shared contract | Tiingo/FRED adapters; archived responses; dated prices/macros; truthful staleness; flag missing observations. Verify terms, configuration and vintage semantics. |
