...
| S5 | Planned; F1 integrated, D021 review open | [Ratios and guided fundamentals](S5-ratios.md) | After S3/S4; eligible source-only work can precede S4b-dependent ratios |
...
| U1 | Draft data/history and price/macro chapters; finished manual pending UI | [Manual and glossary](../features/U1-user-manual.md) | Required before finished release |
| F1 | Plan incorporated 2026-09-19 after S4a; no feature implementation | [Guided fundamentals](../features/F1-fundamentals-guide.md) | S5 → S6 → S8b/S8d/U1; preserve 3/5/10-year history options |
