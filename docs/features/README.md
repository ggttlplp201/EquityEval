...
| --- | --- | --- | --- | --- |
| [N1 — News and macro agent](N1-news-and-macro-agent.md) | 2026-09-11 | US CPI/PPI/Fed events and watchlist news; conditional stock-impact explanations; in-app, desktop and email heads-ups. | S2 design; source/API contracts; N1 workers and delivery alongside S8. | Requirements captured; not running. |
