...
| D009 | Macro proposal ready; ERP/beta still open | S4-04 proposes explicit source-as-of DATE separately from local capture cutoff; no fabricated historical availability. Review design/s4/source-contract.md. ERP/beta source or explicit assumption path remains S7. | S4/S7 |
...
| D019 | Proposed for sequential review — 2026-09-12 | S4-01–04: separate raw/normalized rights gates, compatible provider boundary, eight price/macro tables with explicit missingness, source-date versus capture-cutoff selection and required Timescale acceptance. Direct Treasury CC0 nominal-yield feed proposed first; H.15 bulk raw scope unresolved; live Tiingo/FRED unapproved. See design/s4/source-contract.md. S4b action/ADS lifecycle remains separate. | S4 |
